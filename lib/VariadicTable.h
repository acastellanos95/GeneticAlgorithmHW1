// VariadicTable by friedmud https://github.com/friedmud/variadic_table

#ifndef GENETICALGORITHM_LIB_TABULATE_H_
#define GENETICALGORITHM_LIB_TABULATE_H_
...
#endif //GENETICALGORITHM_LIB_TABULATE_H_
